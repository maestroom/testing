    ...
    public function actionIndex()
    {
        ...
        if (isset($params['TasksUnitsSearch']['unit_assigned_to']) && !empty($params['TasksUnitsSearch']['unit_assigned_to'])) {
            ...
            if (isset($params['TasksUnitsSearch']['unit_assigned_to'])) {
                $unit_assigned_user_name = array();
                if (!empty($params['TasksUnitsSearch']['unit_assigned_to'])) {
                    $unit_assigned_user_name = ArrayHelper::map(User::find()->select(["id", "CONCAT(usr_first_name, ' ' ,usr_lastname) as usr_first_name"])->where('id in (' . implode(",", $params['TasksUnitsSearch']['unit_assigned_to']) . ')')->orderby('tbl_user.usr_first_name')->all(), 'id', 'usr_first_name');
                }
								$unit_assigned_user_name = $additional_arr+$unit_assigned_user_name;
