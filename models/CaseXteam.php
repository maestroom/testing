 ...
 */
class CaseXteam extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['client_case_id', 'team_id', 'team_loc', 'teamservice_id'], 'required'],
            [['client_case_id', 'team_id', 'team_loc', 'teamservice_id','isserviceexcluded'], 'integer'],
