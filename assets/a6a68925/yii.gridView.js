...
(function ($) {
    ...
    var methods = {
        ...
        applyFilter: function () {
            ...
            var dynagird_id=$("#"+$grid.attr('id')).parent().attr('id');
            if($('#'+dynagird_id)){
                $('#'+dynagird_id).removeAttr('data-filter');
            }else{
                if($("body").find("[data-pjax-container='']"))
                $("body").find("[data-pjax-container='']").removeAttr('data-filter');
            }
            ...
            if(hasFilter === "Y"){
                var dynagird_id=$("#"+$grid.attr('id')).parent().attr('id');
                if($('#'+dynagird_id)){
                    $('#'+dynagird_id).attr('data-filter','1');
                }else{
                    if($("body").find("[data-pjax-container='']"))
                    $("body").find("[data-pjax-container='']").attr('data-filter','1');
                }
            }
