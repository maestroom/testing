...
use vendor\Codeigniter\CI_Security;


class CmsInput extends \yii\base\Object
{
    ...
    public function init()
    {
        ...
        Yii::$app->reuest->on('BeginRequest', [$this, 'cleanGlobals']);
    }
    ...
    private function getHtmlPurifier()
    {
        ...
        if(file_exists($file=$basePath.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'htmlpurifier.php'))
