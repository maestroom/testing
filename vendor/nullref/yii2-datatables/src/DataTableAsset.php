...
class DataTableAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        if (empty($this->js)) {
        	//if($this->styling != self::STYLING_CUSTOM)
        ...
        switch ($this->styling) {
            ...
            case self::STYLING_BOOTSTRAP:
                ...
                break;
            case self::STYLING_CUSTOM:
                	$this->css[] = 'custom/css/datatables.css';
                	//$this->js[] = 'custom/js/jquery.dataTables.js';
                	break;
