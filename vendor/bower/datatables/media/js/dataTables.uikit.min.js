...
l=0;for(h=g.length;l<h;l++)if(e=g[l],b.isArray(e))q(c,e);else{d=f="";switch(e){case "ellipsis":f='<em class="uk-icon-ellipsis-h"></em>';d="uk-disabled disabled";break;case "first":f='<em class="uk-icon-angle-double-left"></em> '+k.sFirst;d=0<j?"":" uk-disabled disabled";break;case "previous":f='<em class="uk-icon-angle-left"></em> '+k.sPrevious;d=0<j?"":"uk-disabled disabled";break;case "next":f=k.sNext+' <em class="uk-icon-angle-right"></em>';d=j<n-1?"":"uk-disabled disabled";break;case "last":f=k.sLast+
' <em class="uk-icon-angle-double-right"></em>';d=j<n-1?"":" uk-disabled disabled";break;default:f=e+1,d=j===e?"uk-active":""}f&&(i=b("<li>",{"class":s.sPageButton+" "+d,id:0===r&&"string"===typeof e?a.sTableId+"_"+e:null}).append(b(-1!=d.indexOf("disabled")||-1!=d.indexOf("active")?"<span>":"<a>",{href:"#","aria-controls":a.sTableId,"aria-label":t[e],"data-dt-idx":p,tabindex:a.iTabIndex}).html(f)).appendTo(c),a.oApi._fnBindAction(i,{action:e},m),p++)}},i;try{i=b(h).find(c.activeElement).data("dt-idx")}catch(u){}q(b(h).empty().html('<ul class="uk-pagination uk-pagination-right"/>').children("ul"),
