...
test('format month case with escaped symbols', function (assert) {
    ...
    for (i = 0; i < 12; i++) {
        ...
        assert.equal(moment([2013, i, 1]).format('[<i>]D[</i>] [<strong>]MMMM[</strong>]'), '<i>1</i> <strong>' + months.accusative[i] + '</strong>', '1 <strong>' + months.accusative[i] + '</strong>');
...
test('format month short case with escaped symbols', function (assert) {
    ...
    for (i = 0; i < 12; i++) {
        ...
        assert.equal(moment([2013, i, 1]).format('[<i>]D[</i>] [<strong>]MMM[</strong>]'), '<i>1</i> <strong>' + monthsShort.accusative[i] + '</strong>', '1 <strong>' + monthsShort.accusative[i] + '</strong>');
