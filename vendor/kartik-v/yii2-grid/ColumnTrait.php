...
trait ColumnTrait
{
    ...
    protected function checkValidFilters()
    {
        if (isset($this->filterType)) {
            ...
            /* start: code added to execute function defined in filter type IVT 67,68,86,87,258_v2 */
            if ($this->filterType instanceof \Closure) {
                $this->filterType = call_user_func($this->filterType, $model);
            }
            /* end: code added to execute function defined in filter type */
