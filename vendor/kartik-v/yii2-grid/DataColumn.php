...
class DataColumn extends \yii\grid\DataColumn
{
    ...
    protected function renderFilterCellContent()
    {
        ...
        /* start: code added to execute function defined in filterWidgetOptions IVT 67,68,86,87,258_v2*/
        if ($this->filterWidgetOptions instanceof \Closure) {
			$this->filterWidgetOptions = call_user_func($this->filterWidgetOptions, $model);
		}
		/* END: code added to execute function defined in filterWidgetOptions */
        $options = [
		...
		$this->filterWidgetOptions['pluginOptions']['allowClear'] = false;
