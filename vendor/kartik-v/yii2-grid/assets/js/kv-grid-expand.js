        ...
        $rows.each(function () {
            ...
            var loadDetail = function (postProcess) {
                ...
                expandRow = function (animate) {
                    ...
                    $detail.wrap('<td colspan="' + cols + '" headers="">').parent().wrap(newRow);
                    ...
                    if (animate) {
                        $detail.slideDown(duration, function () {
                            setCollapsed($icon);
                            $detail.show();
                           /* start: custom code for keyboard focus */ 
                             if (!expandAll && !collapseAll)
                                $el.find('.kv-expand-icon a').focus();             
                            /* end: custom code for keyboard focus */
                        });
                    } else {
                        $detail.show();
                        setCollapsed($icon);
