...
(function($) {
    ...
    $.fn.floatThead = function(map) {
        ...
        this.filter(':not(.' + opts.floatTableClass + ')').each(function() {
            ...
            $newHeader.append('<tr class=""><td style="line-height:0px;height:0px!important;height:0px!important;margin:0px!important;padding:0px!important;"></td></tr>');
                ...
                if (count != lastColumnCount) {
                    ...
                    for (var x = 0; x < count; x++) {
                        if (opts.enableAria && (content = $headerColumns.eq(x).text())) {
                            cells.push('<th scope="col" class="floatThead-col" id="" scope="col">' + content + '</th>');
                        } else {
                            var spnTxt = $headerColumns.eq(x).text();
                            if (!spnTxt) {
                                spnTxt = 'Header';
                            }
                            cells.push('<th class="floatThead-col" id="" scope="col"><span class="screenreader">' + spnTxt + '</span></th>');
                        }
                        cols.push('<col/>');
