...
(function ($) {
    ...
    $.fn.fileinputLocales['cr'] = {
        ...
        msgSizeTooLarge: 'Datoteka "{name}" (<strong>{size} KB</strong>) prekoračuje maksimalnu dozvoljenu veličinu datoteke od <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Morate odabrati najmanje <strong>{n}</strong> {files} za otpremanje.',
        msgFilesTooMany: 'Broj datoteka označenih za otpremanje <strong>({n})</strong> prekoračuje maksimalni dozvoljeni limit od <strong>{m}</strong>.',
