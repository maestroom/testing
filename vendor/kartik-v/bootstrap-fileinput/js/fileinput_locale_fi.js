...
(function ($) {
    ...
    $.fn.fileinputLocales.fi = {
        ...
        msgSizeTooLarge: 'Tiedosto "{name}" (<strong>{size} Kt</strong>) ylitt&auml;&auml; suurimman sallitun tiedoston koon, joka on <strong>{maxSize} Kt</strong>. Yrit&auml; uudelleen!',
        msgFilesTooLess: 'V&auml;hint&auml;&auml;n <strong>{n}</strong> {files} tiedostoa on valittava ladattavaksi. Ole hyv&auml; ja yrit&auml; uudelleen!',
        msgFilesTooMany: 'Valittujen tiedostojen lukum&auml;&auml;r&auml; <strong>({n})</strong> ylitt&auml;&auml; suurimman sallitun m&auml;&auml;r&auml;n <strong>{m}</strong>. Ole hyv&auml; ja yrit&auml; uudelleen!',
