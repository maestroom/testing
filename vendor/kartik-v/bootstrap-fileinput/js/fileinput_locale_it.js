...
(function ($) {
    ...
    $.fn.fileinputLocales['it'] = {
        ...
        msgSizeTooLarge: 'Il file "{name}" (<strong>{size} KB</strong>) eccede la dimensione massima di caricamento di <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Devi selezionare almeno <strong>{n}</strong> {files} da caricare.',
        msgFilesTooMany: 'Il numero di file selezionati per il caricamento <strong>({n})</strong> eccede il numero massimo di file accettati <strong>{m}</strong>.',
