...
(function ($) {
    ...
    $.fn.fileinputLocales['pt-BR'] = {
        ...
        msgSizeTooLarge: 'O arquivo "{name}" (<strong>{size} KB</strong>) excede o tamanho máximo permitido de <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Você deve selecionar pelo menos <strong>{n}</strong> {files} para enviar.',
        msgFilesTooMany: 'O número de arquivos selecionados para o envio <strong>({n})</strong> excede o limite máximo permitido de <strong>{m}</strong>.',
