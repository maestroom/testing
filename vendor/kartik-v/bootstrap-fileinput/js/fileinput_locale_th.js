...
(function ($) {
    ...
    $.fn.fileinputLocales['th'] = {
        ...
        msgSizeTooLarge: 'ไฟล์ "{name}" (<strong>{size} KB</strong>) มีขนาดเกินที่ระบบอนุญาตที่ <strong>{maxSize} KB</strong>, กรุณาลองใหม่อีกครั้ง!',
        msgFilesTooLess: 'คุณต้องเลือกไฟล์จำนวนอย่างน้อย <strong>{n}</strong> {files} เพื่ออัพโหลด, กรุณาลองใหม่อีกครั้ง!',
        msgFilesTooMany: 'ไฟล์ที่คุณเลือกมีจำนวน <strong>({n})</strong> ซึ่งเกินกว่าที่ระบบอนุญาตที่ <strong>{m}</strong>, กรุณาลองใหม่อีกครั้ง!',
