...
(function ($) {
    ...
    $.fn.fileinputLocales['sk'] = {
        ...
        msgSizeTooLarge: 'Súbor "{name}" (<strong>{size} KB</strong>): prekročenie - maximálna povolená veľkosť <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Musíte vybrať najmenej <strong>{n}</strong> {files} pre nahranie.',
        msgFilesTooMany: 'Počet vybratých súborov pre nahranie <strong>({n})</strong>: prekročenie - maximálny povolený limit <strong>{m}</strong>.',
