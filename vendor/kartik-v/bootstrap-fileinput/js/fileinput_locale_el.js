...
(function ($) {
    ...
    $.fn.fileinputLocales['el'] = {
        ...
        msgSizeTooLarge: 'Το αρχείο "{name}" (<strong>{size} KB</strong>) υπερβαίνει το μέγιστο επιτρεπόμενο μέγεθος μεταφόρτωσης <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Πρέπει να επιλέξετε τουλάχιστον <strong>{n}</strong> {files} για να ξεκινήσει η μεταφόρτωση.',
        msgFilesTooMany: 'Ο αριθμός των αρχείων που έχουν επιλεγεί για μεταφόρτωση <strong>({n})</strong> υπερβαίνει το μέγιστο επιτρεπόμενο αριθμό <strong>{m}</strong>.',
