...
(function ($) {
    ...
    $.fn.fileinputLocales['nl'] = {
        ...
        msgSizeTooLarge: 'Bestand "{name}" (<strong>{size} KB</strong>) is groter dan de toegestane <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'U moet minstens <strong>{n}</strong> {files} selecteren om te uploaden.',
        msgFilesTooMany: 'Aantal geselecteerde bestanden <strong>({n})</strong> is meer dan de toegestane <strong>{m}</strong>.',
