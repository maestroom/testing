...
(function ($) {
    ...
    $.fn.fileinputLocales['da'] = {
        ...
        msgSizeTooLarge: 'Fil "{name}" (<strong>{size} KB</strong>) er st&oslash;rre end de tilladte <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Du skal mindst v&aelig;lge <strong>{n}</strong> {files} til upload.',
        msgFilesTooMany: '<strong>({n})</strong> filer valgt til upload, men maks. <strong>{m}</strong> er tilladt.',
