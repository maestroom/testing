...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgSizeTooLarge: 'Le fichier "{name}" (<strong>{size} Ko</strong>) dépasse la taille maximale autorisée qui est de <strong>{maxSize} Ko</strong>.',
        msgFilesTooLess: 'Vous devez sélectionner au moins <strong>{n}</strong> {files} à transmettre.',
        msgFilesTooMany: 'Le nombre de fichier sélectionné <strong>({n})</strong> dépasse la quantité maximale autorisée qui est de <strong>{m}</strong>.',
