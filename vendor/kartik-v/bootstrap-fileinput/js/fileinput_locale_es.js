...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgSizeTooLarge: 'Archivo "{name}" (<strong>{size} KB</strong>) excede el tamaño máximo permitido de <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Debe seleccionar al menos <strong>{n}</strong> {files} a cargar.',
        msgFilesTooMany: 'El número de archivos seleccionados a cargar <strong>({n})</strong> excede el límite máximo permitido de <strong>{m}</strong>.',
