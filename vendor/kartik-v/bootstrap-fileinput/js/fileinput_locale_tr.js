...
(function ($) {
    ...
    $.fn.fileinputLocales['tr'] = {
        ...
        msgSizeTooLarge: '"{name}" dosyasının boyutu (<strong>{size} KB</strong>) izin verilen azami dosya boyutu olan <strong>{maxSize} KB</strong>\'tan büyük.',
        msgFilesTooLess: 'Yüklemek için en az <strong>{n}</strong> {files} dosya seçmelisiniz.',
        msgFilesTooMany: 'Yüklemek için seçtiğiniz dosya sayısı <strong>({n})</strong> azami limitin <strong>({m})</strong> altında olmalıdır.',
