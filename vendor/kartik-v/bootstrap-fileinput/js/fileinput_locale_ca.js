...
(function ($) {
    ...
    $.fn.fileinputLocales['ca'] = {
        ...
        msgSizeTooLarge: 'Arxiu "{name}" (<strong>{size} KB</strong>) excedeix la mida màxima permès de <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Heu de seleccionar almenys <strong>{n}</strong> {files} a carregar.',
        msgFilesTooMany: 'El nombre d\'arxius seleccionats a carregar <strong>({n})</strong> excedeix el límit màxim permès de <strong>{m}</strong>.',
