...
(function ($) {
    ...
    $.fn.fileinputLocales['cz'] = {
        ...
        msgSizeTooLarge: 'Soubor "{name}" (<strong>{size} KB</strong>): překročení - maximální povolená velikost <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Musíte vybrat nejméně <strong>{n}</strong> {files} pro nahrání.',
        msgFilesTooMany: 'Počet vybraných souborů pro nahrání <strong>({n})</strong>: překročení - maximální povolený limit <strong>{m}</strong>.',
