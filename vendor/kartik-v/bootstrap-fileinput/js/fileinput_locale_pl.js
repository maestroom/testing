...
(function ($) {
    ...
    $.fn.fileinputLocales['pl'] = {
        ...
        msgSizeTooLarge: 'Plik o nazwie "{name}" (<strong>{size} KB</strong>) przekroczył maksymalną dopuszczalną wielkość pliku wynoszącą <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Musisz wybrać przynajmniej <strong>{n}</strong> {files} do wgrania.',
        msgFilesTooMany: 'Liczba plików wybranych do wgrania w liczbie <strong>({n})</strong>, przekracza maksymalny dozwolony limit wynoszący <strong>{m}</strong>.',
