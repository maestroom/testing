...
(function (factory) {
    ...
    defaultFileActionSettings = {
        removeIcon: '<em class="glyphicon glyphicon-trash text-danger"></em>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<em class="glyphicon glyphicon-upload text-info"></em>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        indicatorNew: '<em class="glyphicon glyphicon-hand-down text-warning"></em>',
        ...
        indicatorLoading: '<em class="glyphicon glyphicon-hand-up text-muted"></em>',
    ...
    FileInput.prototype = {
        ...
        _validate: function () {
            ...
            $exception = '<div class="help-block alert alert-warning">' +
                ...
                'You must set an input <code>type = file</code> for <strong>bootstrap-fileinput</strong> plugin to initialize.' +
                '</div>';
    ...
    $.fn.fileinput.defaults = {
        ...
        zoomIndicator: '<em class="glyphicon glyphicon-zoom-in"></em>',
