...
(function ($) {
    ...
    $.fn.fileinputLocales['hu'] = {
        ...
        msgSizeTooLarge: '"{name}" fájl (<strong>{size} KB</strong>) mérete nagyobb a megengedettnél <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Legalább <strong>{n}</strong> {files} ki kell választania a feltöltéshez.',
        msgFilesTooMany: 'A feltölteni kívánt fájlok száma <strong>({n})</strong> elérte a megengedett maximumot <strong>{m}</strong>.',
