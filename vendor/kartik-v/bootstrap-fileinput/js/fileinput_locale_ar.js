...
(function ($) {
    ...
    $.fn.fileinputLocales['ar'] = {
        ...
        msgSizeTooLarge: 'الملف "{name}" (<strong>{size} ك.ب</strong>) تعدى الحد الأقصى المسموح للرفع <strong>{maxSize} ك.ب</strong>.',
        msgFilesTooLess: 'يجب عليك اختيار <strong>{n}</strong> {files} على الأقل للرفع.',
        msgFilesTooMany: 'عدد الملفات المختارة للرفع <strong>({n})</strong> تعدت الحد الأقصى المسموح به لعدد <strong>{m}</strong>.',
