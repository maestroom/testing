...
(function ($) {
    ...
    $.fn.fileinputLocales['pt'] = {
        ...
        msgSizeTooLarge: 'Ficheiro "{name}" (<strong>{size} KB</strong>) excede o tamanho máximo permido de <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Deve seleccionar pelo menos <strong>{n}</strong> {files} para fazer upload.',
        msgFilesTooMany: 'Número máximo de ficheiros seleccionados <strong>({n})</strong> excede o limite máximo de <strong>{m}</strong>.',
