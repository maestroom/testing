...
(function ($) {
    ...
    $.fn.fileinputLocales['ro'] = {
        ...
        msgSizeTooLarge: 'Fișierul "{name}" (<strong>{size} KB</strong>) depășește limita maximă de încărcare de <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Trebuie să selectezi cel puțin <strong>{n}</strong> {files} pentru a încărca.',
        msgFilesTooMany: 'Numărul fișierelor pentru încărcare <strong>({n})</strong> depășește limita maximă de <strong>{m}</strong>.',
