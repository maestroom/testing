...
(function ($) {
    ...
    $.fn.fileinputLocales['fa'] = {
        ...
        msgSizeTooLarge: 'فایل "{name}" (<strong>{size} کیلوبایت</strong>) از حداکثر مجاز <strong>{maxSize} کیلوبایت</strong>.',
        msgFilesTooLess: 'شما باید حداقل <strong>{n}</strong> {files} فایل برای بارگذاری انتخاب کنید.',
        msgFilesTooMany: 'تعداد فایل‌های انتخاب شده برای بارگذاری <strong>({n})</strong> از حداکثر مجاز عبور کرده است <strong>{m}</strong>.',
