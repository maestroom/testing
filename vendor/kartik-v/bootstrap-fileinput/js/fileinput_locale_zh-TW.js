...
(function ($) {
    ...
    $.fn.fileinputLocales['zh-TW'] = {
        ...
        msgSizeTooLarge: '檔案 "{name}" (<strong>{size} KB</strong>) 大小超過上限 <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: '最少必須選擇 <strong>{n}</strong> {files} 來上傳. ',
        msgFilesTooMany: '上傳的檔案數量 <strong>({n})</strong> 超過最大檔案上傳限制 <strong>{m}</strong>.',
