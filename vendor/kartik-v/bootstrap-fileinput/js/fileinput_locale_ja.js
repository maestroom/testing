...
(function ($) {
    ...
    $.fn.fileinputLocales['ja'] = {
        ...
        msgSizeTooLarge: 'ファイル"{name}" (<strong>{size} KB</strong>)はアップロード可能な上限容量<strong>{maxSize} KB</strong>を超えています',
        msgFilesTooLess: '最低<strong>{n}</strong>個の{files}を選択してください',
        msgFilesTooMany: '選択したファイルの数<strong>({n}個)</strong>はアップロード可能な上限数<strong>({m}個)</strong>を超えています',
