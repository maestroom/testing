...
(function ($) {
    ...
    $.fn.fileinputLocales['bg'] = {
        ...
        msgSizeTooLarge: 'Файла "{name}" (<strong>{size} KB</strong>) надвишава максималните разрешени <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Трябва да изберете поне <strong>{n}</strong> {files} файла.',
        msgFilesTooMany: 'Броя файлове избрани за качване <strong>({n})</strong> надвишава ограниченито от максимум <strong>{m}</strong>.',
