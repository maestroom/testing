...
(function ($) {
    ...
    $.fn.fileinputLocales['id'] = {
        ...
        msgSizeTooLarge: 'Berkas "{name}" (<strong>{size} KB</strong>) melebihi ukuran upload maksimal yaitu <strong>{maxSize} KB</strong>.',
        msgFilesTooLess: 'Anda harus memilih setidaknya <strong>{n}</strong> {files} untuk diunggah.',
        msgFilesTooMany: '<strong>({n})</strong> berkas yang dipilih untuk diunggah melebihi ukuran upload maksimal yaitu <strong>{m}</strong>.',
