...
{
    const CALENDAR_ICON = '<em class="glyphicon glyphicon-calendar"></em>';
    const TYPE_INPUT = 1;
     ...
     * - 'label': string the button label. Defaults to `<em class="glyphicon glyphicon-calendar"></em>`
     */
    ...
    protected function renderAddon(&$options, $type = 'picker')
    {
        ...
        $icon = '<em class="glyphicon glyphicon-' . ArrayHelper::remove($options, 'icon', $icon) . '"></em>';
