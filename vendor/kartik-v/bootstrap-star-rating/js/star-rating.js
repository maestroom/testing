...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        language: 'en',
        stars: 5,
        filledStar: '<em class="glyphicon glyphicon-star"></em>',
        emptyStar: '<em class="glyphicon glyphicon-star-empty"></em>',
        containerClass: '',
        size: 'md',
        animate: true,
        displayOnly: false,
        ...
        clearButton: '<em class="glyphicon glyphicon-minus-sign"></em>',
