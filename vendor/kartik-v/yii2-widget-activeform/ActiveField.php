 ...
 *    echo $this->form->field($model, 'phone', ['addon' => ['type'=>'prepend', 'content'=>'<em class="glyphicon
 *     glyphicon-phone']]);
 * ```
 *
...
class ActiveField extends \yii\widgets\ActiveField
{
     ...
     * - icon: string, the markup to display the help icon. Defaults to `<em class="glyphicon glyphicon-question-sign
     *     text-info"></em>`.
    ...
    protected function initHints()
    {
        ...
        $this->hintSettings = array_replace_recursive([
            ...
            'icon' => '<em class="glyphicon glyphicon-question-sign text-info"></em>',
            'hideOnEscape' => true,
            'hideOnClickOut' => true,
            'placement' => 'top',
            'container' => $container
