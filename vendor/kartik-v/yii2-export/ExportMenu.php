...
class ExportMenu extends GridView
{
     ...
     * - icon: string, defaults to `<em class="glyphicon glyphicon-export"></em>`
     ...
     *     recognized:
     * - label: string, defaults to empty string.
     * - icon: string, defaults to `<em class="glyphicon glyphicon-list"></em>`
    ...
    protected function initColumnSelector()
    {
        ...
        $this->columnSelectorOptions = array_replace_recursive([
            'id' => $id,
            'icon' => '<em class="glyphicon glyphicon-list"></em>',
    ...
    public function renderExportMenu()
    {
        ...
        if ($this->asDropdown) {
            $icon = ArrayHelper::remove($this->dropdownOptions, 'icon', '<em class="glyphicon glyphicon-export"></em>');
