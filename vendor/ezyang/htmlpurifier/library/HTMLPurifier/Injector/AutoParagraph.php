    ...
    public function handleText(&$token)
    {
        ...
        if ($this->allowsElement('p')) {
            if (empty($this->currentNesting) || strpos($text, "\n\n") !== false) {
                ...
                if ($this->_pLookAhead()) {
                    // State 2.1: <div>PAR1<strong>PAR1\n\nPAR2
                    //                 ----
                    ...
                    // State 2.2.2: <div>PAR1<strong>PAR1</strong></div>
                    //                   ----
                }
            }
            ...
            // State 4.1: ...<strong>PAR1
            //                  ----

            // State 4.2: ...<strong>PAR1\n\nPAR2
            //                  ------------
        }
    }
                ...
                if ($this->_isInline($token)) {
                    ...
                    if (!$prev instanceof HTMLPurifier_Token_Start) {
                        ...
                        if ($prev instanceof HTMLPurifier_Token_Text &&
                            ...
                            // State 1.1.1: <div><p>PAR1</p><strong>
                            //                              ---
                            // State 1.1.2: <div><br /><strong>
                            //                         ---
                            // State 1.1.3: <div>PAR<strong>
                            //                      ---
                        }
                    } else {
                        // State 1.2.1: <div><strong>
                        //                   ---
                        // Lookahead to see if <p> is needed.
                        if ($this->_pLookAhead()) {
                            // State 1.3.1: <div><strong>PAR1\n\nPAR2
                            //                   ---
                            $token = array($this->_pStart(), $token);
                        } else {
                            // State 1.3.2: <div><strong>PAR1</strong></div>
                            //                   ---

                            // State 1.3.3: <div><strong>PAR1</strong><div></div>\n\n</div>
                            //                   ---
                        }
                    }
                } else {
