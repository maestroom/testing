...
test('format month case with escaped symbols', function (assert) {
    ...
    for (i = 0; i < 12; i++) {
        ...
        assert.equal(moment([2013, i, 1]).format('[<em>]D[</em>] [<strong>]MMMM[</strong>]'), '<em>1</em> <strong>' + months.accusative[i] + '</strong>', '1 <strong>' + months.accusative[i] + '</strong>');
...
test('format month short case with escaped symbols', function (assert) {
    ...
    for (i = 0; i < 12; i++) {
        ...
        assert.equal(moment([2013, i, 1]).format('[<em>]D[</em>] [<strong>]MMM[</strong>]'), '<em>1</em> <strong>' + monthsShort.accusative[i] + '</strong>', '1 <strong>' + monthsShort.accusative[i] + '</strong>');
