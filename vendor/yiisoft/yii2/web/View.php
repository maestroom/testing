...
class View extends \yii\base\View
{
    ...
    protected function renderHeadHtml()
    {
        ...
        if (!empty($this->js[self::POS_HEAD])) {
            $lines[] = Html::script(implode("\n", $this->js[self::POS_HEAD]), ['type' => 'text/javascript'])."<noscript></noscript>";
        }
    ...
    protected function renderBodyBeginHtml()
    {
        ...
        if (!empty($this->js[self::POS_BEGIN])) {
            $lines[] = Html::script(implode("\n", $this->js[self::POS_BEGIN]), ['type' => 'text/javascript'])."<noscript></noscript>";
        }
    ...
    protected function renderBodyEndHtml($ajaxMode)
    {
        ...
        if ($ajaxMode) {
            ...
            if (!empty($scripts)) {
                $lines[] = Html::script(implode("\n", $scripts), ['type' => 'text/javascript'])."<noscript></noscript>";
            }
        } else {
            if (!empty($this->js[self::POS_END])) {
                $lines[] = Html::script(implode("\n", $this->js[self::POS_END]), ['type' => 'text/javascript'])."<noscript></noscript>";
            }
            if (!empty($this->js[self::POS_READY])) {
                $js = "jQuery(document).ready(function () {\n" . implode("\n", $this->js[self::POS_READY]) . "\n});";
                $lines[] = Html::script($js, ['type' => 'text/javascript'])."<noscript></noscript>";
            }
            if (!empty($this->js[self::POS_LOAD])) {
