...
return array (
  ...
  'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '<strong>{begin, number}-{end, number}</strong> megjelenítése a(z) <strong>{totalCount, number}</strong> elemből.',
  ...
  'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Összesen <strong>{count, number}</strong> elem.',
