...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Приказано <strong>{begin, number}-{end, number}</strong> од <strong>{totalCount, number}</strong> {totalCount, plural, =1{# ставке} one{# ставкe} few{# ставке} many{# ставки} other{# ставки}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Укупно <strong>{count, number}</strong> {count, plural, one{ставка} few{ставке} other{ставки}}.',
