...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Namoyish etilayabdi <strong>{begin, number}-{end, number}</strong> ta yozuv <strong>{totalCount, number}</strong> tadan.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Jami <strong>{count, number}</strong> {count, plural, one{yozuv} few{yozuv} many{yozuv} other{yozuv}}.',
