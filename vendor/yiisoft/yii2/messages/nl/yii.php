...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Resultaat <strong>{begin, number}-{end, number}</strong> van <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Totaal <strong>{count, number}</strong> {count, plural, one{item} other{items}}.',
