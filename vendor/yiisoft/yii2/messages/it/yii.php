...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Visualizzo <strong>{begin, number}-{end, number}</strong> di <strong>{totalCount, number}</strong> {totalCount, plural, one{elemento} other{elementi}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => '{count, plural, one{Elementi} other{Elementi}} totali <strong>{count, number}</strong>.',
