...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '<strong>{totalCount, number}</strong> {totalCount, plural, one{öğenin} other{öğenin}} <strong>{begin, number}-{end, number} arası gösteriliyor.</strong>',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Toplam <strong>{count, number}</strong> {count, plural, one{öğe} other{öğe}}.',
