...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '第 <strong>{begin, number}-{end, number}</strong> 項，共 <strong>{totalCount, number}</strong> 項資料.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => '總計 <strong>{count, number}</strong> 項資料。',
