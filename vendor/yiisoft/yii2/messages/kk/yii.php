...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '<strong>{totalCount, number}</strong> жазбадан <strong>{begin, number}-{end, number}</strong> аралығы көрсетілген.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Барлығы <strong>{count, number}</strong> жазба.',
