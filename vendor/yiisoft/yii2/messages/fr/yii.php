...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Affichage de <strong>{begin, number}-{end, number}</strong> sur <strong>{totalCount, number}</strong> {totalCount, plural, one{élément} other{éléments}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Total <strong>{count, number}</strong> {count, plural, one{élément} other{éléments}}.',
