...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Zobrazujem <strong>{begin, number}-{end, number}</strong> z <strong>{totalCount, number}</strong> {totalCount, plural, one{záznam} other{záznamov}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Celkovo <strong>{count, number}</strong> {count, plural, one{záznam} other{záznamov}}.',
