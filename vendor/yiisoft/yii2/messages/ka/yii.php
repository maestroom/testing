...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'ნაჩვენებია ჩანაწერები <strong>{begin, number}-{end, number}</strong> из <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'სულ <strong>{count, number}</strong> {count, plural, one{ჩანაწერი} few{ჩანაწერი} many{ჩანაწერი}} other{ჩანაწერი}}.',
