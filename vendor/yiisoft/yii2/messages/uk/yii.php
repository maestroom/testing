...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Показані <strong>{begin, number}-{end, number}</strong> із <strong>{totalCount, number}</strong> {totalCount, plural, one{запису} other{записів}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Всього <strong>{count, number}</strong> {count, plural, one{запис} few{записи} many{записів} other{записи}}.',
