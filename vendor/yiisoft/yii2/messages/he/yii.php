...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'מציג <strong>{begin, number}-{end, number}</strong> מתוך <strong>{totalCount, number}</strong> {totalCount, plural, one{רשומה} other{רשומות}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'סך הכל <strong>{count, number}</strong> {count, plural, one{אייטם} other{אייטמים}}.',
