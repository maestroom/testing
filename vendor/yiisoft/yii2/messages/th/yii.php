...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'แสดง <strong>{begin, number} ถึง {end, number}</strong> จาก <strong>{totalCount, number}</strong> ผลลัพธ์',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'ทั้งหมด <strong>{count, number}</strong> ผลลัพธ์',
