...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Εμφανίζονται <strong>{begin, number}-{end, number}</strong> από <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Συνολικά <strong>{count, number}</strong> {count, plural, one{αντικείμενο} few{αντικείμενα} many{αντικείμενα} other{αντικείμενα}}.',
