...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'نمایش <strong>{begin, number} تا {end, number}</strong> مورد از کل <strong>{totalCount, number}</strong> مورد.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'مجموع <strong>{count, number}</strong> مورد.',
