...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Viser <strong>{begin, number}-{end, number}</strong> av <strong>{totalCount, number}</strong> {totalCount, plural, one{element} other{elementer}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Totalt <strong>{count, number}</strong> {count, plural, one{element} other{elementer}}.',
