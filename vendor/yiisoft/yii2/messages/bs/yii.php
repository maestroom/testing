...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Prikazano <strong>{begin, number}-{end, number}</strong> od <strong>{totalCount, number}</strong> {totalCount, plural, one{stavke} other{stavki}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Ukupno <strong>{count, number}</strong> {count, plural, one{stavka} other{stavki}}.',
