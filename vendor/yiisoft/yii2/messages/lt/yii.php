...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Rodomi rezultatai <strong>{begin, number}-{end, number}</strong> iš <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Iš viso <strong>{count, number}</strong> {count, plural, one{elementas} few{elementai} other{elementų}}.',
