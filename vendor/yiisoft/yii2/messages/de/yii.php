...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Zeige <strong>{begin, number}-{end, number}</strong> von <strong>{totalCount, number}</strong> {totalCount, plural, one{Eintrag} other{Einträgen}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Insgesamt <strong>{count, number}</strong> {count, plural, one{Eintrag} other{Einträge}}.',
