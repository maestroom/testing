...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '{totalCount, plural, one{Zobrazen} few{Zobrazeny} other{Zobrazeno}} <strong>{totalCount, plural, one{{begin, number}} other{{begin, number}-{end, number}}}</strong> z <strong>{totalCount, number}</strong> {totalCount, plural, one{záznamu} other{záznamů}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Celkem <strong>{count, number}</strong> {count, plural, one{záznam} few{záznamy} other{záznamů}}.',
