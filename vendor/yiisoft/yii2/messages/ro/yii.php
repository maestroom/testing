...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Sunt afișați itemii <strong>{begin, number}-{end, number}</strong> din <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Total <strong>{count, number}</strong> {count, plural, one{item} other{itemi}}.',
