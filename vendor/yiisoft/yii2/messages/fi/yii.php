...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Näytetään <strong>{begin, number}-{end, number}</strong> kaikkiaan <strong>{totalCount, number}</strong> {totalCount, plural, one{tuloksesta} other{tuloksesta}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Yhteensä <strong>{count, number}</strong> {count, plural, one{tulos} other{tulosta}}.',
