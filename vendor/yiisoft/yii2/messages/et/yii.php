...
return array (
  ...
  'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Näitan <strong>{totalCount, number}</strong> {totalCount, plural, one{üksusest} other{üksusest}} <strong>{begin, number}-{end, number}</strong>.',
  ...
  'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Kokku <strong>{count, number}</strong> {count, plural, one{üksus} other{üksust}}.',
