...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'عرض <strong>{begin, number}-{end, number}</strong> من أصل <strong>{totalCount, number}</strong> {totalCount, plural, one{مُدخل} few{مُدخلات} many{مُدخل} other{مُدخلات}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'مجموع <strong>{count, number}</strong> {count, plural, one{مُدخل} few{مُدخلات} many{مُدخل}}.',
