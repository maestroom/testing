...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '<strong>{totalCount, number}</strong> 件中 <strong>{begin, number}</strong> から <strong>{end, number}</strong> までを表示しています。',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => '合計 <strong>{count}</strong> 件。',
