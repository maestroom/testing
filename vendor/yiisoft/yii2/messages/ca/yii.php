...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Mostrant  <strong>{begin, number}-{end, number}</strong> de <strong>{totalCount, number}</strong> {totalCount, plural, one{element} other{elements}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Total <strong>{count, number}</strong> {count, plural, one{element} other{elements}}.',
