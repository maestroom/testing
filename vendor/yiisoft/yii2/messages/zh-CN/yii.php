...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '第<strong>{begin, number}-{end, number}</strong>条，共<strong>{totalCount, number}</strong>条数据.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => '总计<strong>{count, number}</strong>条数据。',
