...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Trình bày <strong>{begin, number}-{end, number}</strong> trong số <strong>{totalCount, number}</strong> mục.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Tổng số <strong>{count, number}</strong> mục.',
