...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => '<strong>{totalCount, number}</strong> {totalCount, plural, one{elementdən} other{elementdən}} <strong>{begin, number}-{end, number}</strong> arası göstərilir.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Toplam <strong>{count, number}</strong> {count, plural, one{element} other{element}}.',
