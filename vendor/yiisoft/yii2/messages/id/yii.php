...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Menampilkan <strong>{begin, number}-{end, number}</strong> dari <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{item}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Total <strong>{count, number}</strong> {count, plural, one{item} other{item}}.',
