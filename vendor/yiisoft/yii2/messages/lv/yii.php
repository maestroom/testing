...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Tiek rādīti ieraksti <strong>{begin, number}-{end, number}</strong> no <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Kopā <strong>{count, number}</strong> {count, plural, zero{ierakstu} one{ieraksts} other{ieraksti}}.',
