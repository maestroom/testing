...
return array (
  ...
  'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Показване на <strong>{begin, number}-{end, number}</strong> от <strong>{totalCount, number}</strong> {totalCount, plural, one{запис} other{записа}}.',
  ...
  'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => '<strong>{count, number}</strong> {count, plural, one{запис} other{записа}}.',
