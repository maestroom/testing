...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Visar <strong>{begin, number}-{end, number}</strong> av <strong>{totalCount, number}</strong> objekt.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Totalt <strong>{count, number}</strong> objekt.',
