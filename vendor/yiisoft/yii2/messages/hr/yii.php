...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Prikazuj  <strong>{begin, number}-{end, number}</strong> od <strong>{totalCount, number}</strong> {totalCount, plural, =1{stavka} one{# stavka} few{# stavke} many{# stavki} other{# stavki}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Ukupno <strong>{count, number}</strong> {count, plural, =1{stavka} one{# stavka} few{# stavke} many{# stavki} other{# stavki}}.',
