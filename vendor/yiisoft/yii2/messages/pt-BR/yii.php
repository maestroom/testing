...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Exibindo <strong>{begin, number}-{end, number}</strong> de <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{itens}}.',
