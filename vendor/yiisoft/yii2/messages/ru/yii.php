...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Показаны записи <strong>{begin, number}-{end, number}</strong> из <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Всего <strong>{count, number}</strong> {count, plural, one{запись} few{записи} many{записей} other{записи}}.',
