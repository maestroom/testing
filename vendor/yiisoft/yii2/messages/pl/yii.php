...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Wyświetlone <strong>{begin, number}-{end, number}</strong> z <strong>{totalCount, number}</strong>.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Razem <strong>{count, number}</strong> {count, plural, one{rekord} few{rekordy} many{rekordów} other{rekordu}}.',
