...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 'Prikaz <strong>{begin, number}-{end, number}</strong> od <strong>{totalCount, number}</strong> {totalCount, plural, one{Element} two{Elementa} few{Elementi} other{Elementov}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Skupaj <strong>{count, number}</strong> {count, plural, one{element} two{elementa} few{elementi} other{elementov}}.',
