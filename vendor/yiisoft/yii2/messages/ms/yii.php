...
return [
    ...
    'Showing <strong>{begin, number}-{end, number}</strong> of <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.' => 
    'Memaparkan <strong>{begin, number}-{end, number}</strong> daripada <strong>{totalCount, number}</strong> {totalCount, plural, one{item} other{items}}.',
    ...
    'Total <strong>{count, number}</strong> {count, plural, one{item} other{items}}.' => 'Jumlah <strong>{count, number}</strong> {count, plural, one{item} other{items}}.',
