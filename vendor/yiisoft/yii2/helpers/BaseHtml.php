...
class BaseHtml
{
    ...
    {
        return static::tag('script', $content, $options).'<noscript></noscript>';
    }
    ...
    public static function jsFile($url, $options = [])
    {
        ...
        if (isset($options['condition'])) {
            $condition = $options['condition'];
            unset($options['condition']);
            return self::wrapIntoCondition(static::tag('script', '', $options), $condition).'<noscript></noscript>';
        } else {
            return static::tag('script', '', $options).'<noscript></noscript>';
        }
    }
    ...
    public static function checkbox($name, $checked = false, $options = [])
    {
        ...
        if(isset($options['customInput'])){
            $id=uniqid();
            $options['id']=$id;
            return $hidden . static::input('checkbox', $name, $value, $options).'<label for="'.$id.'"></label>';
        }
        if (isset($options['label'])) {
            $label = $options['label'];
            $labelOptions = isset($options['labelOptions']) ? $options['labelOptions'] : [];
