...
class ActiveForm extends Widget
{
    ...
    public function init()
    {
        if (!isset($this->options['id'])) {
		 ...
		 /* start: set this custom option for security defects in SEC to disable autocomplete in all forms in the app. */
        $this->options['autocomplete'] = 'off';
        /* end: set this custom option for security defects in SEC to disable autocomplete in all forms in the app. */
        ob_start();
