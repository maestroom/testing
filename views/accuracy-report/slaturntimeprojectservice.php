        	...
        	<div class="create-form">
					<div class="form-group field-team-team_name required">
						...
						<div class="row input-field">
							...
							<div class="col-md-7">
								<div class="custom-inline-block-width" >
				     				<input type="checkbox" value="client" class="form-control select_client" id="chkselectservice" name="chkselectservice" aria-label="Select Service">
						...
						<div class="row input-field">
							...
							<div class="col-md-7">
								<div class="custom-inline-block-width" >
				     				<input type="checkbox" class="form-control select_client" id="chkselectserviceloc" name="chkselectserviceloc" aria-label="Select All" />
                                                                <label for="chkselectserviceloc"><span class="sr-only">Select All</span></label>
							 	</div>
			    			</div>
			    			<div class="clearfix">&nbsp;</div>
			    			<!-- Get all Select Service -->
						...
						<div class="row input-field">
							...
							<div class="col-md-2">
								<div class="custom-inline-block-width" >
				     				<select class="form-control" name="chartgroupcriteria">
				     					<option value="0"></option>
