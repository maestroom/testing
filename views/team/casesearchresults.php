...
<div id="ires">
		...
		if(!empty($search_results))
		{
			foreach ($search_results as $casearch) {?>
						   	...
						   	<span class="st">
								...
								?>								
						   		<br>
							   		...
							   		{
										if($strattachment=="")
											$strattachment= Html::a("<em class='fa fa-paperclip'></em>",["media/downloadfiles", "name"=>$attachment->id],["title"=>$attachment->fname]);
										else
											$strattachment.='&nbsp;&nbsp;'.Html::a("<em class='fa fa-paperclip'></em>",["media/downloadfiles", "name"=>$attachment->id],["title"=>$attachment->fname]);
									}	
									echo $strattachment;
					...
					{
					$url='index.php?r=task/addInstrctionComment/taskId/'.$casearch['task_id'].'/caseId/'.$casearch['caseId'].'/commentId/'.$casearch['id'];
					?>
					<li class="g">
						<div sig="szg" class="vsc">
						   <h3 class="r">
					...
					{
						$url='index.php?r=case-projects/index&case-id='.$casearch['caseId'].'&todotaskids='.$casearch['task_id'];
					?>
						<li class="g">
							<div sig="szg" class="vsc">
							   <h3 class="r">
