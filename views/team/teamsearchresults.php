...
<div id="ires">
		...
		if(!empty($search_results))
		{
			foreach ($search_results as $casearch) {?>
					...
					{ 
						$url='index.php?r=team-projects/post-comment&task_id='.$casearch['task_id'].'&team_id='.$casearch['team_id'].'&team_loc='.$casearch['team_loc'].'&comment_id='.$casearch['id'];
					?>
					<li class="g">
					...
					{
					//$url='index.php?r=task/addInstrctionComment&taskId='.$casearch['task_id'].'&team_id='.$casearch['team_id'].'&team_loc='.$casearch['team_loc'].'&commentId='.$casearch['id'];
					$url='index.php?r=team-projects/post-comment&task_id='.$casearch['task_id'].'&team_id='.$casearch['team_id'].'&team_loc='.$casearch['team_loc'].'&comment_id='.$casearch['id'];
					if(isset($casearch['caseId'])){
					...
					{
					$url='index.php?r=track/index&taskid='.$casearch['task_id'].'&team_id='.$casearch['team_id'].'&team_loc='.$casearch['team_loc'].'';
					?>
					<li class="g">
						<div sig="szg" class="vsc">
						   <h3 class="r">
					...
					{
						$url='index.php?r=team-projects/index&team_id='.$casearch['team_id'].'&team_loc='.$casearch['team_loc'].'&todotaskids='.$casearch['task_id'];
					?>
						<li class="g">
							<div sig="szg" class="vsc">
							   <h3 class="r">
							...
							<div sig="szg" class="vsc">
							   ...
							   <div class="s">
							   	...
							   	<span class="st">
									...
									$taskinstruct_info=Taskinstruct::find()->where(['tasks_id'=>$casearch['task_id'],'isactive'=>'1'])->one();
