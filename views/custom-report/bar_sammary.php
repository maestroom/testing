...
<div class="rows panel-body" title="Tip: Simply select the function and data from the tabular report that you need to summarize to generate the chart report.  For example, ‘I want to see the COUNT of PROJECT ID by CLIENT NAME.’">
		<div class="form-group col-sm-5 required">
					<div class="row input-field">
						<div class="col-md-4">
							<label class="form_label" for="x_function">I want to see the</label>
						</div>
						<div class="col-md-8">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[x_fn]',
    'data' => ['sum'=>'Sum','count'=>'Count'],
    'options' => ['placeholder' => 'Select X Function', "id"=>"x_function", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
    ...
    'options' => ['placeholder' => 'Select X Data', "id"=>"x_data", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'data' => $field_disply_with_table,
    'options' => ['placeholder' => 'Select Y Data', "id"=>"y_data", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
		...
		<div class="rows panel-body" title="Tip: The application will automatically default an appropriate ‘Display by’ option, but you can adjust if needed.">
			<div class="col-sm-5">
				<div class="form-group  required">
					<div class="row input-field">
						<div class="col-md-4">
							<label class="form_label font13" for="x_function_display_by">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">X Function Display by</span></label>
						</div>
						<div class="col-md-8">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[x_fn_display]',
    'data' => [],
    'options' => ['placeholder' => 'Select X Function Display By', "id"=>"x_function_display_by", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
			...
			<div class="col-sm-3">
					...
					<div class="row input-field">
						<div class="col-md-2">
							<label class="form_label" for="y_data_display_by">&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">Y Data Display by</span></label>
						</div>
						<div class="col-md-10">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[y_data_display]',
    'data' => [],
    'options' => ['placeholder' => 'Select Y Data Display By', "id"=>"y_data_display_by", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?>
...
var ftype=$('#field_types option[value="<?=$post_data['ReportsUserSaved']['y_data']?>"]').text();
			...
			if(ftype == 'VARCHAR' || ftype == 'LOOKUP' || ftype == 'TINYINT'){
