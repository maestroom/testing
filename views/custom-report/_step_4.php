...
<fieldset class="one-cols-fieldset-report overflow-auto">
		...
		$titles=['Bar Basic'=>'Display: Horizontal bars
Use to: Compare items or to show change over time within one series',
		'Bar Clustered'=>'Display: Horizontal bars grouped in clusters
Use to: Compare items or to show change over time across multiple series',
		'Bar Stacked'=>'Display: Horizontal bars grouped in subgroups / stacks 
Use to: See changes in parts of a whole over time across multiple series',
		'Column Basic'=>'Display: Vertical columns
Use to: Compare items or to show change over time within one series',
		'Column Clustered'=>'Display: Vertical columns grouped in clusters
Use to: Compare items or to show change over time across multiple series',
		'Column Stacked'=>'Display: Vertical columns grouped in subgroups / stacks
Use to: See changes in parts of a whole over time across multiple series',
		'Line Basic'=>'Display: A series of markers connected by a line
Use to: See a trend in data over intervals of time within one series',
		'Line Clustered'=>'Display: A series of markers connected by a line
Use to: See a trend in data over intervals of time across multiple series',
		'Circle Pie'=>'Display: Slices of a pie
Use to: See parts of a whole',
		'Circle Donut'=>'Display: Pieces of a donut
Use to: See parts of a whole'];
...
<li title="<?=$titles[$format]?>"><input aria-setsize="8" aria-posinset="<?= $i ?>" title="<?=$titles[$format]?>" data-type="<?=$format?>" class="chart_format" type="radio" name="chart_format_id" value="<?=$id?>" id="chart_format_id_<?=$id?>"> <label for="chart_format_id_<?=$id?>" class=""><span style="display:none!important;"><?=$format?></span></label><strong><?=str_replace(" ","<br><span>",$format."</span>");?><span tabindex="0"><img src="<?=Url::base(true).'/images/'.$images[$format]?>"  alt="<?=$titles[$format]?>" width="32" height="32" title="<?=$titles[$format]?>"></span></strong></li>
		<?php $i++;} ?>
		</ul>	
    ...
    'options' => ['placeholder' => 'Select Title Location', 'aria-label' => 'Title Location',"id"=>"ch_title_location", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Legend Location', 'aria-label' => 'Legend Location', "id"=>"ch_legend_location", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'data' => [''=>'','R'=>'Right','B'=>'Bottom'],
    'options' => ['placeholder' => 'Select Data Table Location', 'aria-label' => 'Data Table Location', "id"=>"ch_datatable_location", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'data' => ['2D'=>'2D','3D'=>'3D'],
    'options' => ['placeholder' => 'Select Dimensions', 'aria-label' => 'Dimensions', "id"=>"ch_dimensions", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['multiple'=>true,'placeholder' => 'Select Grid Lines','aria-label' => 'Grid Lines', "id"=>"ch_bar_p_grid_lines", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Shape','aria-label' => 'Shape', "id"=>"ch_bar_p_shape", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Markers','aria-label' => 'Markers', "id"=>"ch_bar_p_markers", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Fill', 'aria-label' => 'Fill',"id"=>"ch_bar_p_fill", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Slice Position','aria-label' => 'Slice Position', "id"=>"ch_bar_p_slice", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Data Label Location', 'aria-label' => 'Data Label Location',"id"=>"ch_bar_p_data_label_location", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'options' => ['placeholder' => 'Select Y Axis Label Direction', 'aria-label' => 'Y Axis Label Direction',"id"=>"ch_axis_y_label_direction", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'data' => ['Diagonal'=>'Diagonal','Horizontal'=>'Horizontal','Vertical'=>'Vertical'],
    'options' => ['placeholder' => 'Select X Axis Label Direction','aria-label' => 'X Axis Label Direction',"id"=>"ch_axis_x_label_direction", 'nolabel' => true],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
...
<div class="button-set text-right">
	...
	<?= Html::button('Cancel', ['title'=>'Cancel','class' => 'btn btn-primary','onclick'=>'$( "#tabs-step-2" ).show();$( "#tabs-step-1" ).hide();$( "#tabs-step-4" ).hide();post_step();']) ?>
...
function next_step_summary() {
	var ret=true;
	$('#tabs-step-4 .required').each(function() {
		if($(this).css('display') == 'none'){
		}else{
			if($('#'+$(this).data('field')).val() == ''){
				$(this).addClass('has-error');
				$(this).find('.help-block').html($(this).find('.col-md-3').find('label').html() + ' cannot be blank.');
				ret=false;
			}
		}
	});
	...
	$.ajax({
		type: 'post',
			url:baseUrl+'custom-report/summary-report',
			data: form,
