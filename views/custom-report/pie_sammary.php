...
?>
    ...
    'options' => ['placeholder' => 'Select Item Function', "id"=>"item_function", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
    ...
    'options' => ['placeholder' => 'Select Item', "id"=>"y_data", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
    ...
    'data' => $field_disply_with_table,
    'options' => ['placeholder' => 'Select Series', "id"=>"series", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
		...
		<div class="rows  panel-body"  title="Tip: The application will automatically default an appropriate ‘Display by’ option, but you can adjust if needed.">
			<div class="col-sm-5">
				<div class="form-group  required">
					<div class="row input-field">
						<div class="col-md-4">
							<label class="form_label font13" for="item_function_display_by">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">Item Function Display by</span></label>
						</div>
						<div class="col-md-8">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[item_fn_display]',
    'data' => ["Number"=>"Number","Percentage"=>"Percentage","Number_Percentage"=>"Number & Percentage"],
    'options' => ['placeholder' => 'Select Item Function Display By', "id"=>"item_function_display_by", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
			...
			<div class="col-sm-3">
					...
					<div class="row input-field">
						<div class="col-md-2">
							<label class="form_label" for="series1_display_by">&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">Series Display by</span></label>
						</div>
						<div class="col-md-10">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[series1_display]',
    'data' => [],
    'options' => ['placeholder' => 'Select Series Display', "id"=>"series1_display_by", 'nolabel' => true, 'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?>
