...
?>
    ...
    'options' => ['placeholder' => 'Select Y Function', "id"=>"y_function", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
		...
		<div class="rows panel-body"  title="Tip: The application will automatically default an appropriate ‘Display by’ option, but you can adjust if needed.">
			<div class="col-sm-5">
				<div class="form-group  required">
					<div class="row input-field">
						<div class="col-md-4">
							<label class="form_label font13" for="y_function_display_by">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">Y Function Display by</span></label>
						</div>
						<div class="col-md-8">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[y_fn_display]',
    'data' => [],
    'options' => ['placeholder' => 'Select Y Function Display By', "id"=>"y_function_display_by", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?><div class="help-block"></div>
			...
			<div class="col-sm-3">
					...
					<div class="row input-field">
						<div class="col-md-2">
							<label class="form_label" for="x_data_display_by">&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">X Data Display by</span></label>
						</div>
						<div class="col-md-10">
							<?php echo Select2::widget([
    'name' => 'ReportsUserSaved[x_data_display]',
    'data' => [],
    'options' => ['placeholder' => 'Select X Data Display By', "id"=>"x_data_display_by", 'nolabel' => true,'aria-required' => 'true'],
    'pluginOptions' => [
        'allowClear' => true
    ],
]);?>
