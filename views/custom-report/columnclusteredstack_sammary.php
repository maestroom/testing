...
<div class="rows" title="Tip: Simply select the function and data from the tabular report that you need to summarize to generate the chart report.  For example, ‘I want to see the COUNT of PROJECT ID by CLIENT NAME.’">
	<div class="form-group required">
		<div class="row input-field">
			...
			<div class="col-md-2">
				<?php echo Select2::widget(['name' => 'ReportsUserSaved[y_fn]','data' => ['sum'=>'Sum','count'=>'Count'],'options' => ['placeholder' => 'Select Y Function', "id"=>"y_function", 'nolabel' => true,'aria-required' => 'true'],'pluginOptions' => ['allowClear' => true],]);?>
	...
	<div class="form-group required" title="Tip: The application will automatically default an appropriate ‘Display by’ option, but you can adjust if needed.">
		<div class="row input-field">
			<div class="col-md-2 step4_S2div1">
				<label for="y_function_display_by" class="form_label font13">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">Y Function Display by</span></label>
			</div>
			<div class="col-md-2">
				<?php echo Select2::widget(['name' => 'ReportsUserSaved[y_fn_display]','data' => [],'options' => ['placeholder' => 'Select Y Function Display By', "id"=>"y_function_display_by", 'nolabel' => true,'aria-required' => 'true'],'pluginOptions' => ['allowClear' => true],]);?>
				<div class="help-block"></div>
			</div>
			<!-- -->
			...
			<div class="col-md-1 step4_S2div4">
					<label for="x_data_display_by" class="form_label font13">&nbsp;&nbsp;&nbsp;&nbsp;<span class="not-set">X Data Display by</span></label>
			</div>
			<div class="col-md-2">
				<?php echo Select2::widget(['name' => 'ReportsUserSaved[x_data_display]','data' => [],'options' => ['placeholder' => 'Select X Data Display By', "id"=>"x_data_display_by", 'nolabel' => true,'aria-required' => 'true'],'pluginOptions' => ['allowClear' => true],]);?>
