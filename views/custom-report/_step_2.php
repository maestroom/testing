...
<span class="input-group-addon">
    <i class="glyphicon glyphicon-calendar"  title="Select Date"></i>
</span>
HTML;
...
<fieldset class="one-cols-fieldset-report">
	<div class="col-sm-12 add-custom-report-stap-two">
		<div class="col-sm-5">
			<h4 class="form_label">
			<a href="javascript:void(0);" title="Available Fields" class="tag-header-black">Available Fields </a>
			...
			<fieldset>
			<legend class="sr-only">Available Fields</legend>
			<div class="mycontainer" id="avail_field_data"></div>
			</fieldset>
		</div>
		<div class="col-sm-1">
			<div class="section-arrow-fixed text-center"><a href="javascript:void(0);" class="link-arrow-main" id="select_report_field" title="Move Available Fields To Report Fields"><em class="glyphicon glyphicon-chevron-right text-primary fa-2x" title="Select Report Fields"><span class="not-set">Select Report Fields</span></em></a></div>
		</div>
		<div class="col-sm-6">
				...
				if(!empty($fields)){
						foreach($fields as $field){
							...
							<li data-field_name="<?= $calculation_field->calculation_name ?>" data-table_name="Calc" class="report_<?=$field->field_calculation_id?> li_<?=$field->field_calculation_id?>" id="<?=$field->field_calculation_id?>">
								...
								<input name="fielddisp[<?=$field->field_calculation_id?>]" id="fielddisp_<?=$field->field_calculation_id?>" value="Invoice  Subtotal" type="hidden">
								<input name="fieldval[<?=$field->field_calculation_id?>]" id="fieldval_<?=$field->field_calculation_id?>" value="Calc.Invoice  Subtotal" type="hidden">
								<a href="javascript:void(0);" class="icon-set" onclick="remove_field(<?=$field->field_calculation_id?>)"><span class="fa fa-close text-primary pull-right" title="Remove" aria-label="Delete"><span class="not-set">Remove</span></span></a>
								<a class="icon-set handel_sort" href="javascript:void(0);"><span class="fa fa-arrows text-primary pull-right" title="Move"><span class="not-set">Move</span></span></a>
								<a href="javascript:void(0);" id="sorting-category<?=$field->field_calculation_id?>" class="icon-set" onclick="sorting_popup(<?=$field->field_calculation_id?>);" title="Add Sorting"><i class="glyphicon glyphicon-chevron-up text-primary pull-right" title="Sorting"><span class="not-set">Sorting</span></i></a>
								<a href="javascript:void(0);" class="icon-set" onclick="filter_pop_up(<?=$field->field_calculation_id?>);" id="filter_icon_<?=$field->field_calculation_id?>"><span class="glyphicon glyphicon-filter text-primary pull-right" title="Filter"><span class="not-set">Filter</span></span></a>
								<a href="javascript:void(0);" class="icon-set" onclick="group_pop_up(<?=$field->field_calculation_id?>);" id="grouping-category<?=$field->field_calculation_id?>"><span class="glyphicon glyphicon-plus-sign <?php if($field->field_group_type > 0){ $grouping_value[$field->field_calculation_id]=array('id'=>$field->field_calculation_id,'group-type'=>$field->field_group_type);?>text-danger<?php }else{?> text-primary<?php }?> pull-right" title="Format"><span class="not-set">Format</span></span></a>
							</li>
							<?php
							}else{
						...
						<li data-field_name="<?=$field_info->field_name?>" data-table_name="<?=$field_info->reportsTables->table_name?>" class="report_<?=$reportfield->id?> li_<?=$reportfield->id?>" id="<?=$reportfield->id?>">
							...
							<input name="fielddisp[<?=$reportfield->id?>]" id="fielddisp_<?=$reportfield->id?>" value="Project Name" type="hidden">
							...
							<a href="javascript:void(0);" class="icon-set" onclick="remove_field(<?=$reportfield->id?>)"><span class="fa fa-close text-primary pull-right" title="Remove" aria-label="Remove"><span class="not-set">Remove</span></span></a>
							<a class="icon-set handel_sort" href="javascript:void(0);"><span class="fa fa-arrows text-primary pull-right" title="Move"><span class="not-set">Move</span></span></a>
							<a href="javascript:void(0);" id="sorting-category<?=$reportfield->id?>" class="icon-set" onclick="sorting_popup(<?=$reportfield->id?>);" title="Add Sorting"><?php if($field->field_sort_type ==1) { ?><i class="text-danger pull-left">1</i><?php }?><?php if($field->field_sort_type ==2) { ?><i class="text-danger pull-left">2</i><?php }?><?php if($field->field_sort_type ==3) { ?><i class="text-danger pull-left">3</i><?php }?><i class="glyphicon  <?php if($field->field_sort_type  > 0) { $sorting_values[$reportfield->id]=array('id'=>$reportfield->id,'sort-type'=>$field->field_sort_type,'sort-order'=>$field->field_sort_order);?> text-danger <?php if($field->field_sort_order == 1){?>glyphicon-arrow-up<?php } if($field->field_sort_order == 2){?>glyphicon-arrow-down<?php }  }else{?> glyphicon-chevron-up  text-primary<?php }?> pull-right" title="Sorting"><span class="not-set">Sorting</span></i></a>
							<a href="javascript:void(0);" class="icon-set" onclick="filter_pop_up(<?=$reportfield->id?>);" id="filter_icon_<?=$reportfield->id?>"><span class="glyphicon glyphicon-filter <?php if(!empty($logic)) {
								...
								?>text-danger<?php }else{?>text-primary<?php }?> pull-right" title="Filter"><span class="not-set">Filter</span></span></a>
						<a href="javascript:void(0);" class="icon-set" onclick="group_pop_up(<?=$reportfield->id?>);" id="grouping-category<?=$reportfield->id?>"><span class="glyphicon glyphicon-plus-sign <?php if($field->field_group_type > 0) { $grouping_value[$reportfield->id]=array('id'=>$reportfield->id,'group-type'=>$field->field_group_type);?>text-danger<?php }else{?> text-primary<?php }?> pull-right" title="Format"><span class="not-set">Format</span></span></a>
						</li>
				<?php }
					}
				}?>
...
<div class="button-set text-right">
    <?= Html::button('Previous', ['title'=>'Previous','class' =>  'btn btn-primary','onclick'=>'$( "#tabs-step-1" ).show();$( "#tabs-step-2" ).hide(); $(".sub-heading").html("<a href=\"javascript:void(0)\" class=\"tag-header-black\" title=\"Step 1: Select Report Type.\">Step 1: Select Report Type.</a>");']) ?>
    <?php /*= Html::button('Cancel', ['title'=>'Previous','class' => 'btn btn-primary','onclick'=>'$( "#tabs-step-1" ).show();$( "#tabs-step-2" ).hide(); $(".sub-heading").text("Step1 : Select Report Type, Format & Dates");']) */?>
    <?= Html::button('Clear', ['title'=>'Clear','class' => 'btn btn-primary','onclick'=>'$("#table_field_container").html(null);$("#filter_custom_values").html(null);$("#sorting_custom_values").html(null);$("#chart_custom_values").html(null);']) ?>
    <?= Html::button('Next', ['title'=>'Next','class' =>  'btn btn-primary','id'=>'nextstep2','onclick'=>'post_step();']) ?>
</div>
<script>
jQuery(document).ready(function(){
<?php if(isset($flag) && $flag=='run'){ ?>	
    showLoader();
    setTimeout(function(){post_step();},200);
<?php }?>
});
	...
	$('#select_report_field').click(function(){
		...
		$('.table_field:checked').each(function(){
			...
			var filterTag = '<a href="javascript:void(0);" class="icon-set" onClick="filter_pop_up('+id+');" id="filter_icon_'+id+'"><span class="glyphicon glyphicon-filter '+filter_class+' pull-right" title="Filter"><span class="not-set">Filter</span</span></a>';
			var groupTag  = '';
			...
			if($('.select_report_fields').find('.report_'+id).length == 0){ // condition check
				...
				*/
				if(report_typeId=='T'){
					$( ".select_report_fields" ).append('<li data-field_name="'+field_vals+'" data-table_name="'+table_name+'" class="report_'+id+' li_'+id+'" id='+id+'>'+display_field.attr('data-table-display-name')+" => "+display_name+'<input type="hidden" name="fielddisp['+id+']" id="fielddisp_'+id+'" value="'+display_name+'" /><input type="hidden" name="fieldval['+id+']" id="fieldval_'+id+'" value="'+val+'" /><a href="javascript:void(0);" class="icon-set" aria-label="Remove" onClick="remove_field('+id+')"><span class="fa fa-close text-primary pull-right" title="Remove" aria-label="Remove"><span class="not-set">Remove</span></span></a><a class="icon-set handel_sort" href="javascript:void(0);"><span class="fa fa-arrows text-primary pull-right" title="Move"><span class="not-set">Move</span></span></a><a href="javascript:void(0);" id="sorting-category'+id+'" class="icon-set" onClick="sorting_popup('+id+');" title="Add Sorting"><i class="glyphicon glyphicon-chevron-up text-primary pull-right" title="Sorting"><span class="not-set">Sorting</span></i></a>'+filterTag+groupTag+'</li>');
				}if(report_typeId=='C'){
					$( ".select_report_fields" ).append('<li data-field_name="'+field_vals+'" data-table_name="'+table_name+'" class="report_'+id+' li_'+id+'" id='+id+'>'+display_field.attr('data-table-display-name')+" => "+display_name+'<input type="hidden" name="fielddisp['+id+']" id="fielddisp_'+id+'" value="'+display_name+'" /><input type="hidden" name="fieldval['+id+']" id="fieldval_'+id+'" value="'+val+'" /><a href="javascript:void(0);" class="icon-set" onClick="remove_field('+id+')"><span class="fa fa-close text-primary pull-right" title="Remove"><span class="not-set">Remove</span></span></a><a class="icon-set handel_sort" href="javascript:void(0);"><span class="fa fa-arrows text-primary pull-right" title="Move"><span class="not-set">Move</span></span></a><a href="javascript:void(0);" id="sorting-category'+id+'" class="icon-set" onClick="sorting_popup('+id+');" title="Add Sorting"><i class="glyphicon glyphicon-chevron-up text-primary pull-right" title="Sorting"><span class="not-set">Sorting</span></i></a>'+filterTag+'<a href="javascript:void(0);" class="icon-set" id="chart-category'+id+'" onClick="display_by_report_field('+id+');"><span class="glyphicon glyphicon-tags text-primary pull-right" title="Axis"><span class="not-set">Axis</span></span></a>');
					...
					{ 
						  ...
						  click: function () { 
							 if(confirm("Are you sure you want to clear selected Axis for field "+fieldval+"")){
									...
									$('#chart-category'+id).html('<span class="glyphicon glyphicon-tags pull-right" title="Axis"><span class="not-set">Axis</span</span>');	
									$(this).dialog('destroy').remove();
					   ...
					   { 
							...
							{ 
								...
								if(chart_axis=='l'){
									...
									var chart_legend = $("#chart_legend_values").val();
									$("#chart_legend_values").val(id);
									$('#chart-category'+id).html('<span class="text-danger">'+chart_axis+'</span><span class="glyphicon glyphicon-tags pull-right text-danger" title="Legend"><span class="not-set">Legend</span</span>');	
				...
				buttons: [
						{
						  ...
						  click: function () { 
							  ...
							  if(confirm("Are you sure you want to clear sort order for field "+display_name+"")){
									...
									$('#sorting-category'+id).html('<i class="glyphicon glyphicon-chevron-up pull-right" title="Sorting"><span class="not-set">Sorting</span</i>');	
							...
							"title": 'Update',
							  ...
							  { 
								...
								if(sort_order==1) {
									...
									$('#sorting-category'+id).html('<i class="text-danger pull-left">'+sort_type+'</i><i class="glyphicon glyphicon-arrow-up text-danger pull-right" title="'+hover+'"><span class="not-set">'+hover+'</span</i>');
									//$('#sorting-category'+id).attr("onclick","remove_sorting_popup("+id+");");
									$('#sorting-category'+id).attr("title",hover);
								} else if(sort_order==2) {
									hover=hover+'Descending';
									$('#sorting-category'+id).html('<i class="text-danger pull-left">'+sort_type+'</i><i class="glyphicon glyphicon-arrow-down text-danger pull-right" title="'+hover+'"><span class="not-set">'+hover+'</span</i>');
									//$('#sorting-category'+id).attr("onclick","remove_sorting_popup("+id+");");
									$('#sorting-category'+id).attr("title",hover);
								} else {
									$('#sorting-category'+id).html('<i class="glyphicon glyphicon-chevron-up pull-right" title="Sorting"><span class="not-set">Sorting</span</i>');	
				...
				buttons: [
						{
						  ...
						  click: function () { 
							  ...
							  if(confirm("Are you sure you want to clear grouping for field "+display_name+"")){
									...
									$('#grouping-category'+id).html('<span class="glyphicon glyphicon-plus-sign text-primary pull-right" title="Format"><span class="not-set">Format</span</span>');	
						  ...
						  "class": 'btn btn-primary',
							"title": 'Update',
							  ...
							  { 
								...
								// sort order
								if(hover!=""){
									$('#grouping-category'+id).html('<span class="text-danger pull-left"></span><span class="glyphicon glyphicon-plus-sign text-danger" title="'+hover+'"><span class="not-set">'+hover+'</span</span>');
									$('#sorting-category'+id).attr("title",hover);
								} else {
									$('#grouping-category'+id).html('<span class="glyphicon glyphicon-plus-sign" title="Format"><span class="not-set">Format</span</span>');	
	...
	*/
					   ...
					   { 
							...
							{ 
								...
								$('#filter-option-popup tr.field-operator-id').each(function(){
									...
									/* if(($.trim(opt=="undefined")) || ($.trim(opt==""))){
			...
			if(($('#reportsusersaved-report_format_id option:selected').text().toLowerCase() == 'chart' && (($('#reportsusersaved-chart_format_id option:selected').text().toLowerCase() == 'pie' && $('.chart-values').length!=1) || ($('#reportsusersaved-chart_format_id option:selected').text().toLowerCase() != 'pie' && $('.chart-values').length!=2)))){
				...
				$.ajax({
					...
					error :function(response){
						...
						$( "#tabs-step-2" ).hide();
						$( "#tabs-step-2" ).css('display','none');
						$( "#btn_add_chart" ).attr("disabled",true);
						createView();
						}else{
							$( "#tabs-step-1" ).show();
							$( "#tabs-step-2" ).hide(); 
							$(".sub-heading").html("<a href=\"javascript:void(0)\" class=\"tag-header-black\" title=\"Step 1: Select Report Type.\">Step 1: Select Report Type.</a>");
						}
					}
				});
			}
	...
	function createView(){
		var URL = baseUrl+'custom-report/preview-report&createview=true';
				if($('#reportsusersaved-report_format_id').val()==2){
					var URL = baseUrl+'custom-report/preview-chart-report&createview=true';
				}
				var form = $('#report-type-format-dates').serialize();
				// Ajax Post
				$.ajax({
