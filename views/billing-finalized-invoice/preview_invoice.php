...
$this->title = 'Finalized Invoice Preview';
?>
<div class="right-main-container">
	...
	<div class="button-set text-right">
		...
		<button onclick="edit_invoice(<?= $invoice['id']; ?>,'preview');" title="Edit" class="btn btn-primary" id="editrequest" type="button" name="yt2">Edit</button>
