			...
			<?php $form = ActiveForm::begin(['id' => 'add-comments-form-'.$id,'enableAjaxValidation' => false,'enableClientValidation' => true]); ?>
			 ...
			 <div class="comments-area">
				 <div class="x_panel custom-wording-editer">
                            <div class="x_content">
				 <?= $form->field($model, 'comment',['inputOptions'=>['style'=>"display:block;width:100%;height:350px!important;"],'template' => "<div class='col-md-0'>{label}</div><div class='col-md-12' style='padding:0px!important;'>{input}\n{hint}\n{error}</div>",'labelOptions'=>['class'=>'form_label']])->textArea(['id'=>'add_comment_'.$id,'rows'=>2,'placeholder'=>"Leave a comment..."])->label(false);?>
				 </div>
				 </div>
			 	<!--<div class="x_panel custom-wording-editer">
                            <div class="x_content">
...
$('document').ready(function(){
	$('#active_form_name').val('add-comments-form-<?= $id ?>');
});
$(function () {
