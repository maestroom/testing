...
<div class="col-sm-12 custom-full-width">
	<div class="col-sm-6"><input aria-setsize="2" aria-posinset="1" type="radio" id="all_users" class="users" name="users" value="1" /><label for="all_users">All Users</label></div>
	<div class="col-sm-6"><input aria-setsize="2" aria-posinset="2" type="radio" checked id="select_users" class="users" name="users" value="0" /><label for="select_users">Selected Users</label></div>
</div>

<div class="mycontainer">
	<!-- Case Manager Roles -->
	<div style="float:right;margin:4px 12px;"><span>Select All</span><div class="pull-right">
            <input type="checkbox" aria-label="Select All" id="select_user_all" name="select_user_all" value="select_user_all" />
