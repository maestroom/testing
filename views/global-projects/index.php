...
$this->title = 'Global Projects';
$this->params['breadcrumbs'][] = $this->title;
$columns=[
	['class' => '\kartik\grid\ExpandRowColumn', 'detailUrl' => Url::to(['global-projects/get-details']),'headerOptions'=>['scope'=>'col','title'=>'Expand/Collapse All','class'=>'first-th', 'id'=>'global_project_expand','aria-label'=>'Projects Expand/Collapse All'], 'filterOptions'=>['headers'=>'global_project_expand'], 'contentOptions'=>['title'=>'Expand/Collapse Row','class' => 'first-td','headers'=>'global_project_expand'], 'expandIcon' => '<a href="javascript:void(0);" aria-label="Expand Row"><span class="glyphicon glyphicon-plus"><span class="not-set">Expand</span></a>', 'collapseIcon' => '<a href="javascript:void(0);" aria-label="Collapse Row"><span class="glyphicon glyphicon-minus"><span class="not-set">Collapse</span></span></a>', 'expandTitle' => 'Expand', 'collapseTitle' => 'Collapse', 'expandAllTitle' => 'Expand All', 'collapseAllTitle' => 'Collapse All', 'mergeHeader'=>false, 'value' => function ($model) { return 1;},'order'=>DynaGrid::ORDER_FIX_LEFT],
	...
	['attribute' => 'id','format' => 'raw', 'filterInputOptions' => ['title' => 'Filter By Project #'], 'label'=>'Project #','headerOptions'=>['scope'=>'col','title'=>'Project #','class'=>'projectno-width-th','id'=>'global_project_id'],'filterOptions'=>['headers'=>'global_project_id'],'contentOptions' => ['class' => 'word-break text-center projectno-width', 'headers'=>'global_project_id'],
	'value' =>  function ($model) { return $model->getTaskInstruction($model->id, $model->task_status); },
...
<div class="right-main-container" id="media_container">
    ...
    'gridOptions'=>[
		...
		'pjax'=>true,
			'pjaxSettings'=>[
					'options'=>['id'=>'globalproject-pajax','enablePushState' => false],
					'neverTimeout'=>true,
					'beforeGrid'=>'',
					'afterGrid'=>'',
			],
...
?>
    ...
    <div class="button-set text-right">
		<input type="hidden" id="dynamic_filter" value="0" />
		<?= Html::a('All Projects', ['/global-projects/index'], ['class'=>'btn btn-primary all_filter','title'=>"All Projects",'style'=>'display:none;']) ?>
		<div class="col-sm-6 pull-right">
			<div class="col-sm-9 pull-left">
				<input type="text" tab-index="1" title="Enter Filter Name" name="save_filter" id="save_filter" class="form-control" placeholder="Enter Filter Name">
				<label for="save_filter" style="display:none;">Enter Filter Name</label>
			</div>
			<div class="col-sm-3 pull-right">
				<?= Html::a('Save', null, ['href'=>'javascript:void(0)','class'=>'btn btn-primary','title'=>"Saved Filter",'onclick'=>'submit_savedynamicfiltter();']) ?>
			</div>
		</div>
   </div>
</div>
...
var $grid = $('#globalprojectgrid-pajax');
...
var interval = setInterval(function(){
	if($('#client_filter').find('div.custom-checkbox').length != 0){
		hideLoader();
		myStopFunction();
	}else{
		showLoader();
