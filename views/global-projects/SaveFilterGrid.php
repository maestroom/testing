...
<div class="right-main-container" id="media_container">
    ...
    'options'=>[
    'id'=>'dynagrid-globalproject-saved',
...
?>
    ...
    <div class="button-set text-right">
    	 <?= Html::a('All Projects', null,['href'=>Url::toRoute(['global-projects/save-filter-grid','filter_id'=>$filter_id]),'class'=>'btn btn-primary all_filter','title'=>"All Projects",'style'=>'display:none;']) ?>
    	 <?php if ((new User)->checkAccess(2.01)){ ?>
    	 <?= Html::a('Filter Options', null, ['href'=>'javascript:void(0)','class'=>'btn btn-primary','title'=>"Filter Options",'onclick'=>'FilterOptions('.$filter_id.');']) ?>
    	 <?php } ?>
    </div>
</div>
<script>
