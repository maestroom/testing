...
<?= Alert::widget() ?>
    <div class="site-index">
      <div class="body-content">
        <div class="row">          
          <div class="col-md-12">
            <div id="page-title" role="heading" class="page-header"><em title="Price List - Internal Team Pricing" class="fa fa-wrench"></em> Price List - <span>Internal Team Pricing</span></div>
          </div>
		</div>
		<div class="row">
...
<footer class="footer" role="contentinfo">
  <div class="container">
    <div class="footer-main">
      <p class="text-center">&copy; 2016 Inovitech, LLC All Rights Reserved. <a href="#" title="Terms">Terms</a>&nbsp; | &nbsp; Version  1.003</p>
    </div>
  </div>
</footer>
