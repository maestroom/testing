...
use app\components\ReportLeftPanel;
...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Html::encode('Reports') ?></title>
    <?php $this->head() ?>
</head>
<body>
<?php $this->beginBody() ?>
      ...
      <div class="body-content">
        <div class="row">          
          <div class="col-md-12">
			  ...
			  <em class="fa fa-pie-chart" title="Reports"></em> <span><a href="javascript:void(0);" title="Reports" class="tag-header-red">Reports</a></span></div>
          </div>
		</div>
		<div class="row">
			  <div class="col-xs-12 col-sm-4 col-md-3 left-side">
	          	<?= ReportLeftPanel::widget(); ?>
	          </div>
