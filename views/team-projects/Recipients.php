<div class="mycontainer">
                    ...
                    <?php foreach ($role_data as $id=>$role){ ?>
                        <li>
                            ...
                            <div class="pull-right"> 
                                <input type="checkbox" aria-labelledby="label_case_role_<?php echo $id ?>" <?php if(in_array($id,$cases_ids)) { ?> checked="checked" <?php } ?> <?php if($id==Yii::$app->user->identity->role_id) {?>checked="checked"<?php } ?> class="case_roles" name="case_role[<?php echo $id?>]" value="<?php echo $id?>" id="case_role_<?php echo $id?>" data-id="<?php echo $id; ?>" title="<?php echo $role?>" >
                                <!--<label for="case_role_<?php echo $id ?>" class="case_role_result">&nbsp; </label>-->
                            </div>
                        </li>
                    <?php } ?>
	        </ul>
    ...
    <div class="content">
        <fieldset>
            <legend class="sr-only">Teams</legend>
            <ul>
                ...
                <ul class="search-teams-result">
                    ...
                    <li>
                        <!--<span id="lbl_team_<?= $team_id?>"><?= $team; ?></span>-->
                        <label for="team_<?= $team_id?>" class="chkbox-global-design teams-role-chk-lbl <?= $checked ?>"><?= $team; ?></label>
                        <div class="pull-right"> 
                            <input type="checkbox" aria-labelledby="lbl_team_<?= $team_id?>" <?= $checked ?> class="teams-role-chk" name="team[<?php echo $team_id?>]" id="team_<?= $team_id?>" value="<?= $team_id?>" data-id="<?= $team_id; ?>" title="<?= $team?>" />
