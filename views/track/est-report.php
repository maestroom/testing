...
<div class="right-main-container">
	<fieldset class="two-cols-fieldset project-comments est-reports">
		<div class="sub-heading"><a href="javascript:void(0);" title="Project % Complete" class="tag-header-black">Project % Complete</a></div>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table borderless" id="casespend_table">
						   					<tbody>
									 			...
									 			<tr>
									 				...
									 				<td>
													<?php
													 	//(new Options)->ConvertOneTzToAnotherTz($taskinstruct->task_duedate." ".$taskinstruct->task_timedue, 'UTC', $_SESSION['usrTZ']); 
														 echo $taskinstruct->task_date_time;
													?>
													</td>
									 			</div>
									 			<tr>
