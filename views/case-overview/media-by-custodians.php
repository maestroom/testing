...
<div class="right-main-container">			
	<div class="sub-heading"><a href="javascript:void(0);" class="tag-header-black" title="Media By Custodian">Media By Custodian</a></div>
...
$('#exportpdf').click(function () {
    if (typeof chart1 != 'undefined') {
    	...
    	//generateChartPDF("clsperiodchart","MediaByCustodiansChartPDF_");
        ...
        var casename = "<?php echo $caseInfo->case_name; ?>";
            ...
            $(form).attr("action", baseUrl+"export-excel/media-by-custodian");   
            $(form).append('<input type="hidden" name="chart_report" value="mediabycustodian" />');
...
function noreport() {
    $("#periodchart").html("<div class='noreport'>No media by custodian found...</div>");
}

<?php if (isset($mediacustodianjson) && $mediacustodianjson != "" && $mediacustodianjson != "[]") { ?>
    var casename = "<?php echo $caseInfo->case_name; ?>";
    createPieChart(<?php echo $mediacustodianjson; ?>, 'Media By Custodians for ' + casename);
<?php } else { ?>
    noreport();
<?php } ?>
</script>
